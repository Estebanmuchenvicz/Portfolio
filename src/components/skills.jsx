...
function Skills() {
  return (
    <div className="flex flex-col items-center justify-center">
      <div>
        <h3 className="text-3xl mt-8 font-bold">Mis Habilidades</h3>
      </div>
      <div className='bg-white shadow-lg p-6 rounded-xl card'>
        <div className="flex flex-wrap space-x-4 mt-4">
          <div className="flex flex-wrap">
            ...
            <div className="max-w-14 mx-2">
              <img src={express} alt="Wordpress" className="w-14 h-14 text-black" />
            </div>
            <div className="max-w-14 mx-2">
              <img src={java} alt="Wordpress" className="w-14 h-14 text-black" />
            </div>
          </div>
        </div>
      </div>
